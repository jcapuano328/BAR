...
import ica.BAR.Adapters.TabsPagerAdapter;
import ica.BAR.Core.*;
...
public class GameActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    private void nextTurn() {
		Bar.nextTurn(game, saved);
		update();
		save(); 
	}

    private void prevPhase() {
    	Bar.prevPhase(game, saved);
		update();
		save(); 
	}
    private void nextPhase() {
    	Bar.nextPhase(game, saved);
		update();
		save(); 
	}
    
    private void update() {
		txtTurn.setText(Bar.getCurrentTurn(game, saved));
		txtPhase.setText(Bar.getCurrentPhase(game, saved));
	}
