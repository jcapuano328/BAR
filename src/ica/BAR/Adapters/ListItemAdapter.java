 ...
 */
public class ListItemAdapter extends ArrayAdapter<ica.BAR.Core.Game> {
    private final Context context;
    private final List<ica.BAR.Core.Game> values;

    public ListItemAdapter(Context context, List<ica.BAR.Core.Game> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ica.BAR.Core.Game game = values.get(position);
